...
def train(epoch):
    global metrics, loader_train, model, optimizer, args
    model.train()
    loss_batch = 0
    batch_count = 0
    is_fst_loss = True
...
def vald(epoch):
    global metrics, loader_val, constant_metrics, model, args
    model.eval()
    loss_batch = 0
    batch_count = 0
    is_fst_loss = True
...
def main():
    global args, loader_train, loader_val, model, optimizer, scheduler, checkpoint_dir, metrics, constant_metrics
